...
namespace SchoolProject.Core.Feature.Students.Commands.Behaviors
{
       ...
       where TRequest : IRequest<TResponse>
    {
        ...
        public ValidationBehavior(IEnumerable<IValidator<TRequest>> validators, IStringLocalizer<SharedResourse> stringLocalizer)
        {
